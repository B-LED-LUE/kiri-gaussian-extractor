"""Second-pass SAM2 masking on a different set of rendered views (e.g. Zero123++ views).
Same interface as feed_for_sam.py — use when you need to refine masks from a different camera set.
"""
import argparse
import numpy as np
import cv2
...
parser = argparse.ArgumentParser(description="Second-pass SAM2 masking on rendered views")
