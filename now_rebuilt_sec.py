"""Second-pass multi-view voting using re-masked views (e.g. from feed_for_meshing cameras).
Same logic as now_rebuilt.py — use for refinement after first-pass extraction.
"""
import argparse
import numpy as np
import json
...
parser = argparse.ArgumentParser(description="Second-pass multi-view voting")
